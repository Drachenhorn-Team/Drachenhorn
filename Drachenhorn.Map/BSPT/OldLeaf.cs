...
{
    internal class OldLeaf : IDrawingItem
    {
        ...
        public OldLeaf Child1; // the Leaf's left child Leaf
        public OldLeaf Child2; // the Leaf's right child Leaf
        ...
        public OldLeaf(int x, int y, int width, int height)
        {
            // initialize our leaf
            X = x;
            Y = y;
        ...
        private bool Split()
        {
            ...
            if (splitH)
            {
                Child1 = new OldLeaf(X, Y, Width, split);
                Child2 = new OldLeaf(X, Y + split, Width, Height - split);
            }
            else
            {
                Child1 = new OldLeaf(X, Y, split, Height);
                Child2 = new OldLeaf(X + split, Y, Width - split, Height);
            }
