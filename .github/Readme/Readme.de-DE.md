...
Grundsätzlich kann jeder mit normal Github-Abläufen zu diesem Programm beitragen, allerdings wäre es schön, wenn ihr damit wartet, bis die Version [0.1.0](https://github.com/lightlike/Drachenhorn/milestone/1) fertig ist, damit ich die Grundstruktur erstellen kann.
